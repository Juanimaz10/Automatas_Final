...
class CsvFile:
    def __init__(self) -> None:
        self.__csvFile = read_csv("./Resources/Listado temas 2023.csv", low_memory=False).drop_duplicates(subset=[COLUMN_TRACK])
...
# OPTION 4
    ...
    def addMusicToCsvFile(self):
        ...
        if loadSongbyFile == 2:
            ...
            with open('./Resources/Listado temas 2023.csv', mode='a', newline='', encoding='utf-8') as file:
...
# OPTION 5
    def lisTop10SongsByDuration(self, top10=10):
        ...
        topSongsMostDurations = csvFileSorted
        topSongsMostDurations = topSongsMostDurations.head(top10).copy()        
...
# Option 6
    def listTop10ArtistsByViews(self):
        ...
        top_10_artists_by_views = csv_file_sorted.drop_duplicates(subset=["Artist"])
        top_10_artists_by_views = top_10_artists_by_views.head(10)[['Artist', 'Views']]
